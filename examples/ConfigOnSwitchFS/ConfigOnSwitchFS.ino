...
void setup()
{
  ...
  Serial.println(ESP32_SC_W6100_MANAGER_VERSION);
  ...
  ESP32_SC_W6100_manager.setDebugOutput(true);

#if !USE_DHCP_IP
  // Set (static IP, Gateway, Subnetmask, DNS1 and DNS2) or (IP, Gateway, Subnetmask)
  ESP32_SC_W6100_manager.setSTAStaticIPConfig(EthSTA_IPconfig);
#endif
  ...
  if (initialConfig)
  {
    ...
    //ESP32_SC_W6100_manager.setConfigPortalTimeout(600);
