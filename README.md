...
* [Why do we need this ESP32_SC_W6100_Manager library](#why-do-we-need-this-ESP32_SC_W6100_Manager-library)
  * [Features](#features)
...
* [Debug Terminal Output Samples](#debug-terminal-output-samples)
  * [1. ConfigOnDoubleReset_TZ using LittleFS on ESP32S3_DEV with ESP32_S3_W6100](#1-ConfigOnDoubleReset_TZ-using-LittleFS-on-ESP32S3_DEV-with-ESP32_S3_W6100)
  * [2. ConfigOnSwichFS using LittleFS on ESP32S3_DEV with ESP32_S3_W6100](#2-ConfigOnSwichFS-using-LittleFS-on-ESP32S3_DEV-with-ESP32_S3_W6100)
  * [3. ESP32_FSWebServer_DRD using LittleFS on ESP32S3_DEV with ESP32_S3_W6100](#3-ESP32_FSWebServer_DRD-using-LittleFS-on-ESP32S3_DEV-with-ESP32_S3_W6100)
* [Debug](#debug)
...
### Why do we need this [ESP32_SC_W6100_Manager library](https://github.com/khoih-prog/ESP32_SC_W6100_Manager)
...
This [**ESP32_SC_W6100_Manager** library](https://github.com/khoih-prog/ESP32_SC_W6100_Manager) currently supports these following boards:
...
## Prerequisites
 ...
 4. [`WebServer_ESP32_SC_W6100 library v1.2.1+`](https://github.com/khoih-prog/WebServer_ESP32_SC_W6100) if necessary to use ESP32_S2/S3/C3 boards using LwIP W6100 Ethernet. To install, check [![arduino-library-badge](https://www.ardu-badge.com/badge/WebServer_ESP32_SC_W6100.svg?)](https://www.ardu-badge.com/WebServer_ESP32_SC_W6100)
...
The best and easiest way is to use `Arduino Library Manager`. Search for `ESP32_SC_W6100_Manager`, then select / install the latest version. You can also use this link [![arduino-library-badge](https://www.ardu-badge.com/badge/ESP32_SC_W6100_Manager.svg?)](https://www.ardu-badge.com/ESP32_SC_W6100_Manager) for more detailed instructions.

### Manual Install

1. Navigate to [ESP32_SC_W6100_Manager](https://github.com/khoih-prog/ESP32_SC_W6100_Manager) page.
2. Download the latest release `ESP32_SC_W6100_Manager-main.zip`.
3. Extract the zip file to `ESP32_SC_W6100_Manager-main` directory 
4. Copy the whole `ESP32_SC_W6100_Manager-main` folder to Arduino libraries' directory such as `~/Arduino/libraries/`.

### VS Code & PlatformIO:

1. Install [VS Code](https://code.visualstudio.com/)
2. Install [PlatformIO](https://platformio.org/platformio-ide)
3. Install [**ESP32_SC_W6100_Manager** library](https://registry.platformio.org/libraries/khoih-prog/ESP32_SC_W6100_Manager) by using [Library Manager](https://registry.platformio.org/libraries/khoih-prog/ESP32_SC_W6100_Manager/installation). Search for **ESP32_SC_W6100_Manager** in [Platform.io Author's Libraries](https://platformio.org/lib/search?query=author:%22Khoi%20Hoang%22)
...
Thanks to [Roshan](https://github.com/solroshan) to report the issue in [Error esp_littlefs.c 'utime_p'](https://github.com/khoih-prog/ESP32_SC_W6100_Manager/issues/28) 
...
```cpp
#include <ESP32_SC_W6100_Manager.hpp>               //https://github.com/khoih-prog/ESP32_SC_W6100_Manager
```

in many files. But be sure to use the following `#include <ESP32_SC_W6100_Manager.h>` **in just 1 `.h`, `.cpp` or `.ino` file**, which must **not be included in any other file**, to avoid `Multiple Definitions` Linker Error

```cpp
// To be included only in main(), .ino with setup() to avoid `Multiple Definitions` Linker Error
#include <ESP32_SC_W6100_Manager.h>          //https://github.com/khoih-prog/ESP32_SC_W6100_Manager
```

Have a look at the discussion in [Different behaviour using the src_cpp or src_h lib #80](https://github.com/khoih-prog/ESP32_SC_W6100_Manager/discussions/80)
...
// Must be placed before #include <ESP32_SC_W6100_Manager.h>
...
///////////////////////////////////////////
/******************************************
   // Defined in ESP32_SC_W6100_Manager.hpp
  typedef struct
  {
...
```cpp
//ESP32_SC_W6100_manager.setSTAStaticIPConfig(stationIP, gatewayIP, netMask, dns1IP, dns2IP);
ESP32_SC_W6100_manager.setSTAStaticIPConfig(WM_STA_IPconfig);
```
...
```cpp
String tempTZ = ESP32_SC_W6100_manager.getTimezoneName();
```
...
```cpp
const char * TZ_Result = ESP32_SC_W6100_manager.getTZ(_timezoneName);
```
...
ESP32_SC_W6100_Manager ESP32_SC_W6100_manager();
```
...
```cpp
ESP32_SC_W6100_Manager ESP32_SC_W6100_manager("Personalized-HostName");
```

then later call

```cpp
ESP32_SC_W6100_manager.startConfigPortal()
```
...
These illustrating steps is based on the example [ConfigOnSwitchFS](https://github.com/khoih-prog/ESP32_SC_W6100_Manager/tree/main/examples/ConfigOnSwitchFS)
...
The example [ConfigOnSwitchFS](https://github.com/khoih-prog/ESP32_SC_W6100_Manager/tree/main/examples/ConfigOnSwitchFS) will open the CP whenever a SW press is detected in `loop()`. So the code to add `dynamic variables` will be there, just after the CP `ESP32_SC_W6100_Manager` class initialization to create `ESP32_SC_W6100_Manager` object.
...
// is configuration portal requested?
  if ((digitalRead(TRIGGER_PIN) == LOW) || (digitalRead(TRIGGER_PIN2) == LOW))
  {
    ...
    ESP32_SC_W6100_Manager ESP32_SC_W6100_manager("ConfigOnSwitchFS");
...
Adding those `ESP32_EMParameter` objects created in Step 2 using the function `addParameter()` of object `ESP32_SC_W6100_Manager`
...
ESP32_SC_W6100_manager.addParameter(&p_thingspeakApiKey);
ESP32_SC_W6100_manager.addParameter(&p_sensorDht22);
ESP32_SC_W6100_manager.addParameter(&p_pinSda);
ESP32_SC_W6100_manager.addParameter(&p_pinScl);
```
...
After users select `Save`, the CP `ESP32_SC_W6100_Manager` object will save the user input data into related `ESP32_EMParameter` objects.
...
<p align="center">
    <img src="https://github.com/khoih-prog/ESP32_SC_W6100_Manager/raw/main/Images/Main.png">
</p>

Select `Information` to enter the Info page where the board info will be shown (long page)

<p align="center">
    <img src="https://github.com/khoih-prog/ESP32_SC_W6100_Manager/raw/main/Images/Info.png">
</p>
...
<p align="center">
    <img src="https://github.com/khoih-prog/ESP32_SC_W6100_Manager/raw/main/Images/Configuration_Standard.png">
</p>
...
<p align="center">
    <img src="https://github.com/khoih-prog/ESP32_SC_W6100_Manager/raw/main/Images/Saved.png">
</p>
...
```cpp
ESP32_SC_W6100_manager.setSaveConfigCallback(saveConfigCallback);
```
...
```cpp
ESP32_SC_W6100_manager.setConfigPortalTimeout(120);
```
...
void loop()
{
  ...
  if ((digitalRead(TRIGGER_PIN) == LOW) || (digitalRead(TRIGGER_PIN2) == LOW))
  {
    ...
    ESP32_SC_W6100_Manager ESP32_SC_W6100_manager("ConfigOnSwitch");
    ...
    ESP32_SC_W6100_manager.setSTAStaticIPConfig(stationIP, gatewayIP, netMask);
#endif
#endif

#if USING_CORS_FEATURE
    ESP32_SC_W6100_manager.setCORSHeader("Your Access-Control-Allow-Origin");
#endif
    ...
    if (loadConfigData())
    {
      ESP32_SC_W6100_manager.setConfigPortalTimeout(
    ...
    else
    {
      ...
      ESP32_SC_W6100_manager.setConfigPortalTimeout(0);
    ...
    if (!ESP32_SC_W6100_manager.startConfigPortal())
    ...
    const char * TZ_Result = ESP32_SC_W6100_manager.getTZ(Ethconfig.TZ_Name);
    ...
    ESP32_SC_W6100_manager.getSTAStaticIPConfig(EthSTA_IPconfig);
...
Many applications need configuration parameters like `MQTT host and port`, [Blynk](http://www.blynk.cc) or [emoncms](http://emoncms.org) tokens, etc. While it is possible to use [`ESP32_SC_W6100_Manager`](https://github.com/khoih-prog/ESP32_SC_W6100_Manager) to collect additional parameters, it is better to read these parameters from a web service once [`ESP32_SC_W6100_Manager`](https://github.com/khoih-prog/ESP32_SC_W6100_Manager) has been used to connect to the Internet.

To capture other parameters with [`ESP32_SC_W6100_Manager`](https://github.com/khoih-prog/ESP32_SC_W6100_Manager) is a little bit more complicated than all the other features. This requires adding custom HTML to your form. 

If you want to do it with [`ESP32_SC_W6100_Manager`](https://github.com/khoih-prog/ESP32_SC_W6100_Manager) see the example [ConfigOnSwitchFS](examples/ConfigOnSwitchFS)
...
```cpp
ESP32_SC_W6100_manager.setSTAStaticIPConfig(IPAddress(192,168,2,232), IPAddress(192,168,2,1), IPAddress(255,255,255,0));
```
...
```cpp
ESP32_SC_W6100_manager.setCustomHeadElement("<style>html{filter: invert(100%); -webkit-filter: invert(100%);}</style>");
```
...
ESP32_SC_W6100_manager.addParameter(&custom_text);
```
...
https://github.com/khoih-prog/ESP32_SC_W6100_Manager/blob/e71d847282bc5d873295c36332fb7f50632633cb/examples/ConfigOnSwitch/ConfigOnSwitch.ino#L25-L905
...
#### 1. ConfigOnDoubleReset_TZ using LittleFS on ESP32S3_DEV with ESP32_S3_W6100

##### 1.1 DRD => Config Portal

This is terminal debug output when running [ConfigOnDoubleReset](examples/ConfigOnDoubleReset) on  **ESP32_S3_W6100**. `Config Portal` was requested by DRD to input and save Credentials, such as Static IP address.

```
Starting ConfigOnDoubleReset_TZ using LittleFS on ESP32S3_DEV with ESP32_S3_W6100
ESP32_SC_W6100_Manager v1.0.0
...
Local Date/Time: Sat Jan 14 20:05:27 2023
Stop doubleResetDetecting
Saving config file...
Saving config file OK
Local Date/Time: Sat Jan 14 20:06:27 2023
Local Date/Time: Sat Jan 14 20:07:27 2023
Local Date/Time: Sat Jan 14 20:08:27 2023
Local Date/Time: Sat Jan 14 20:09:27 2023
```

---

#### 2. ConfigOnSwichFS using LittleFS on ESP32S3_DEV with ESP32_S3_W6100

This is terminal debug output when running [ConfigOnSwichFS](examples/ConfigOnSwichFS) on  **ESP32_S3_W6100**. `Config Portal` was requested to input and save Credentials.


```
Starting ConfigOnSwichFS using LittleFS on ESP32S3_DEV with ESP32_S3_W6100
ESP32_SC_W6100_Manager v1.0.0
[EM] Default SPI pinout:
[EM] SPI_HOST: 2
[EM] MOSI: 11
...
[EM] freeing allocated params!
Local Date/Time: Sat Jan 14 20:13:27 2023
...
Config file was successfully saved
[EM] freeing allocated params!
Local Date/Time: Sat Jan 14 20:14:27 2023
Local Date/Time: Sat Jan 14 20:15:27 2023
Local Date/Time: Sat Jan 14 20:16:27 2023
Local Date/Time: Sat Jan 14 20:17:27 2023
```

---

#### 3. ESP32_FSWebServer_DRD using LittleFS on ESP32S3_DEV with ESP32_S3_W6100

This is terminal debug output when running [ESP32_FSWebServer_DRD](examples/ESP32_FSWebServer_DRD)  on  **ESP32_S3_W6100**. `Config Portal` was requested by DRD (also using **LittleFS**) to input and save Credentials.


```cpp
Starting ESP32_FSWebServer_DRD using LittleFS on ESP32S3_DEV with ESP32_S3_W6100
ESP32_SC_W6100_Manager v1.0.0
ESP_DoubleResetDetector v1.3.2
...
```cpp
ESP32_SC_W6100_manager.setDebugOutput(false);
```
...
Submit issues to: [ESP32_SC_W6100_Manager issues](https://github.com/khoih-prog/ESP32_SC_W6100_Manager/issues)
...
- The library is licensed under [MIT](https://github.com/khoih-prog/ESP32_SC_W6100_Manager/blob/main/LICENSE)
